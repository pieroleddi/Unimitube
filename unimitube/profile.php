...
<body>
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-6">
                <h1 style="font-size: 30px">Carlo</h1>
                <img src="<?php while($row = $resfoto->fetch_assoc()) {print_r($row["foto"]);}?>" class="" style="height: 150px; width: 150px">
                <form class="mt-2" method="post" action="php/update.php" id="formupdate">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <!-- template for friend's list-->
                <div class="row mb-4" id="friend-template" style="text-align: center">
                    <div class="col-2">
                        <img class="card-img-top" src="..." alt="Card image cap" style="width: 50px; height: auto">
                    </div>
                    <div class="col-8">
                        <h5>Piero Leddi</h5>
                        <small>Here friendship info</small>
                    </div>
                    <div class="col-2">
                        <button class="btn btn-light btn-sm"><i class="far fa-trash-alt"></i></button>
                    </div>
                </div>
                <div class="row mb-4" id="friend-template" style="text-align: center">
                    <div class="col-2">
